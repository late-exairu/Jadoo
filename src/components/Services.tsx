  ...
  return (
    <section>
      <Container className="">
        ...
        <ul className="md:mt-18 mx-auto mb-8 mt-16 flex max-w-[700px] flex-col items-center gap-y-4 md:mb-10 md:flex-row md:flex-wrap md:items-stretch md:justify-center md:gap-y-8 lg:mb-12 lg:mt-20 lg:max-w-full lg:justify-center">
