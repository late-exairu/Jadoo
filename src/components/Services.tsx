  ...
  return (
    <section>
      <Container className="relative">
        ...
        <ul className="md:mt-18 mx-auto mt-16 flex max-w-[700px] flex-col items-center gap-y-4 md:mb-4 md:flex-row md:flex-wrap md:items-stretch md:justify-center md:gap-y-8 lg:mb-6 lg:mt-20 lg:max-w-full lg:justify-center">
